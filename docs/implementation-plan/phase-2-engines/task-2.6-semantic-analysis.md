...
| **檔案位置** | `/Users/skyler/coding/CheapCut/docs/implementation-plan/phase-2-engines/task-2.6-semantic-analysis.md` |
...
describe('Task 2.6 - Functional: 語意分析', () => {
